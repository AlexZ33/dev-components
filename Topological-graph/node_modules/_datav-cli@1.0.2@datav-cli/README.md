...
![创建组件](https://gw.alicdn.com/tfs/TB12Dk6QFXXXXX8apXXXXXXXXXX-2798-878.png)
...
![预览组件](https://gw.alicdn.com/tfs/TB1LCtFQVXXXXc1XpXXXXXXXXXX-1894-652.png)

预览组件的工具栏一共有4页.

#### 配置页

![配置页](https://gw.alicdn.com/tfs/TB1u8NmQVXXXXcXXVXXXXXXXXXX-986-878.png)

配置页描述了组件所有能改动的配置,配置页的配置随意改动,组件都会相应的改动.

#### 数据页

![数据页](https://gw.alicdn.com/tfs/TB1VjR1QVXXXXayXXXXXXXXXXXX-996-1276.png)

数据页描述了组件的数据接口配置,数据页的数据随意改动,组件都会相应.

#### 缩放页

![缩放页](https://gw.alicdn.com/tfs/TB1WRp0QVXXXXaMXXXXXXXXXXXX-990-1274.png)

缩放页描述了组件的缩放情况,任意拖动组件容器长度\宽度,组件都会正确更新渲染.

#### 其他页

![其他页](https://gw.alicdn.com/tfs/TB17FN5QVXXXXXQXXXXXXXXXXXX-986-1544.png)
...
打包命令，讲组件打成一个.tar.gz包，在datav.aliyun.com的上传组件页中可以进行上传。
